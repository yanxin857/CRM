...
<body>
	...
	<form action="workbench/transaction/save.do" method="post" id="tranForm" class="form-horizontal" role="form" style="position: relative; top: -30px;">
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				<input type="text" class="form-control" id="create-activitySrc" value="搜狗推广" />
				<input type="hidden" value="d3d380cd42094bb9b9c21cf4b34d7187" name="activityId" />
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-sm-10" style="width: 300px;">
				...
				<input type="hidden" value="05d9ed2dcbc94c6b8ac5295ccbfa6c1d" name="contactsId" />
			</div>
		</div>
